 ...
 *
 * Lo switch del main link in caso di ritrasmissione è gestito nel task poichè l'evento deve essere notificato
 * quanto prima, cioè prima dell'accodamento di datagrammmi che potrebbero essere destinati in upstream verso
 * un' interfaccia non più funzioanante
 */
void receive_task(void* pvParameters);

/**
 * @brief task di invio. Implementa il dispatching dei datagrammi. Il nodo root deaccoda dalla coda a priorità
 * e manda i datagrammi dati ai livelli superiori, oppure risponde ai messaggi di controllo
 *
 * il nodo generico manda i datagrammi dati di cui è destinatario ai livelli superiori, instrada gli altri e implementa
 * il control plane
 */
